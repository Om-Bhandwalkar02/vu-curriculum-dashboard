...
from .views import (overview, swot_revision, incremental_growth, curriculum_flexibility,
                    ...
                    industry_skills, global_benchmarking, ugc_compliance, lacunae_gaps, academic_review)

urlpatterns = [
    path('', overview, name='overview'),
    path('swot-rQevision/', swot_revision, name='swot_revision'),
    ...
    path('academic-review/', academic_review, name='academic_review'),
